...
{
	return ((  bool (*) (Dictionary_2_tCF07B60F69D32E885E7514159E70FD1DAA732BE9 *, int32_t, const RuntimeMethod*))Dictionary_2_ContainsKey_m379C08BE13D2E0AD1F9102B6E280A32F0C9C7015_gshared)(__this, ___key0, method);
}
...
IL_007f:
	...
	}
	{
		...
		Func_1__ctor_m513B0E5967A777E63476A8264B759B2BA052E8DC(L_18, __this, (intptr_t)((intptr_t)RegionPinger_RegionPingThreaded_m52FA3B2BE2C89C20B6C15F7BEF2FFF7647444949_RuntimeMethod_var), /*hidden argument*/Func_1__ctor_m513B0E5967A777E63476A8264B759B2BA052E8DC_RuntimeMethod_var);
		...
		SupportClass_StartBackgroundCalls_m97526EE667EC704A455FD13C141D62E21253A282(L_18, 0, L_23, /*hidden argument*/NULL);
	}
	...
	{ // begin try (depth: 1)
		{
			...
			IPAddressU5BU5D_t7F25C4C038C43BFDA8EA84969112E82BADC38BC3* L_12 = Dns_GetHostAddresses_mBB73A3CFACAF787C2DDB8EF473E87D31940A379D(L_11, /*hidden argument*/NULL);
			V_3 = L_12;
			// if (address.Length == 1)
			IPAddressU5BU5D_t7F25C4C038C43BFDA8EA84969112E82BADC38BC3* L_13 = V_3;
			NullCheck(L_13);
			V_4 = (bool)((((int32_t)(((int32_t)((int32_t)(((RuntimeArray*)L_13)->max_length))))) == ((int32_t)1))? 1 : 0);
			bool L_14 = V_4;
			if (!L_14)
			{
				goto IL_005f;
...
IL_004f:
		{
			...
			IPAddressU5BU5D_t7F25C4C038C43BFDA8EA84969112E82BADC38BC3* L_15 = V_3;
			NullCheck(L_15);
			int32_t L_16 = 0;
			IPAddress_t77F35D21A3027F0CE7B38EA9B56BFD31B28952CE * L_17 = (L_15)->GetAt(static_cast<il2cpp_array_size_t>(L_16));
			NullCheck(L_17);
...
IL_0064:
		{
			...
			V_8 = (bool)((!(((RuntimeObject*)(IPAddress_t77F35D21A3027F0CE7B38EA9B56BFD31B28952CE *)L_23) <= ((RuntimeObject*)(RuntimeObject *)NULL)))? 1 : 0);
			bool L_24 = V_8;
			if (!L_24)
			{
				goto IL_00b0;
...
IL_0076:
		{
			...
			NullCheck(L_26);
			bool L_27 = String_Contains_m4488034AF8CB3EEA9A205EB8A1F25D438FF8704B(L_26, _stringLiteral05A79F06CF3F67F726DAE68D18A2290F6C9A50C9, /*hidden argument*/NULL);
			V_9 = L_27;
			bool L_28 = V_9;
			if (!L_28)
			{
...
IL_008e:
		{
			...
			IPAddress_t77F35D21A3027F0CE7B38EA9B56BFD31B28952CE * L_29 = V_7;
			NullCheck(L_29);
...
IL_00a6:
		{
			...
			IPAddressU5BU5D_t7F25C4C038C43BFDA8EA84969112E82BADC38BC3* L_34 = V_3;
			NullCheck((RuntimeObject *)(RuntimeObject *)L_34);
			String_t* L_35 = VirtFuncInvoker0< String_t* >::Invoke(3 /* System.String System.Object::ToString() */, (RuntimeObject *)(RuntimeObject *)L_34);
			V_0 = L_35;
		}
...
IL_00b7:
		{
			// for (int index = 0; index < address.Length; index++)
			int32_t L_37 = V_6;
			IPAddressU5BU5D_t7F25C4C038C43BFDA8EA84969112E82BADC38BC3* L_38 = V_3;
			NullCheck(L_38);
...
CATCH_00c7:
	{ // begin catch(System.Exception)
		...
		NullCheck(L_41);
		ArrayElementTypeCheck (L_41, _stringLiteral1EE4A675163636BEB79F30AD722D126F26EECE4A);
		(L_41)->SetAt(static_cast<il2cpp_array_size_t>(0), (RuntimeObject *)_stringLiteral1EE4A675163636BEB79F30AD722D126F26EECE4A);
		...
		NullCheck(L_44);
		ArrayElementTypeCheck (L_44, _stringLiteral6A45E3C688C6F85CFA35336EC4FA5A2D6A3E9798);
		(L_44)->SetAt(static_cast<il2cpp_array_size_t>(2), (RuntimeObject *)_stringLiteral6A45E3C688C6F85CFA35336EC4FA5A2D6A3E9798);
		ObjectU5BU5D_t3C9242B5C88A48B2A5BD9FDA6CD0024E792AF08A* L_45 = L_44;
		Exception_t * L_46 = V_12;
		NullCheck(L_46);
		String_t* L_47 = VirtFuncInvoker0< String_t* >::Invoke(9 /* System.String System.Exception::get_Source() */, L_46);
		NullCheck(L_45);
		...
		NullCheck(L_48);
		ArrayElementTypeCheck (L_48, _stringLiteral04BA22605C7AB0E4B7E316FEEE1182537F162E18);
		(L_48)->SetAt(static_cast<il2cpp_array_size_t>(4), (RuntimeObject *)_stringLiteral04BA22605C7AB0E4B7E316FEEE1182537F162E18);
		ObjectU5BU5D_t3C9242B5C88A48B2A5BD9FDA6CD0024E792AF08A* L_49 = L_48;
		Exception_t * L_50 = V_12;
		NullCheck(L_50);
		String_t* L_51 = VirtFuncInvoker0< String_t* >::Invoke(5 /* System.String System.Exception::get_Message() */, L_50);
		NullCheck(L_49);
		ArrayElementTypeCheck (L_49, L_51);
		(L_49)->SetAt(static_cast<il2cpp_array_size_t>(5), (RuntimeObject *)L_51);
		String_t* L_52 = String_Concat_mB7BA84F13912303B2E5E40FBF0109E1A328ACA07(L_49, /*hidden argument*/NULL);
		Debug_WriteLine_m0340AA03A71685D0C1BF132EF3173A33860132C2(L_52, /*hidden argument*/NULL);
		goto IL_010f;
	} // end catch (depth: 1)
...
IL_00b9:
	{
		...
		NullCheck(L_36);
		String_t* L_37 = PhotonPeer_get_ClientVersion_m2A40E299025E03015641C18B33FA8BA33F740318(L_36, /*hidden argument*/NULL);
		NullCheck(L_34);
	...
	}
	{
		...
		NullCheck(L_52);
		Type_t * L_53 = PhotonPeer_get_SocketImplementation_m4CFE54CA5FCF0BB5820A1B42914AD7484D3A5198_inline(L_52, /*hidden argument*/NULL);
		IL2CPP_RUNTIME_CLASS_INIT(Type_t_il2cpp_TypeInfo_var);
...
IL_015c:
	...
	}
	{
		...
		NullCheck(L_58);
		Type_t * L_59 = PhotonPeer_get_SocketImplementation_m4CFE54CA5FCF0BB5820A1B42914AD7484D3A5198_inline(L_58, /*hidden argument*/NULL);
		NullCheck(L_59);
...
IL_01d4:
	{
		...
		NullCheck(L_91);
		String_t* L_92 = PhotonPeer_get_PeerID_mCFE1D8A04860C907EB895FB4888E2572E6E6FEE8(L_91, /*hidden argument*/NULL);
		NullCheck(L_89);
		...
		NullCheck(L_103);
		String_t* L_104 = PhotonPeer_get_ServerIpAddress_m4666717F31CA5968B11172E63A30E0470EC725EA(L_103, /*hidden argument*/NULL);
		NullCheck(L_101);
